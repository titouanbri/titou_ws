...
public:
   ...
   *
   * @brief Loads the force torque filter from the parameter server
   *
   * @param key The key to search in the parameter server.
   * @param nh The ROS NodeHandle to access the parameter server.
