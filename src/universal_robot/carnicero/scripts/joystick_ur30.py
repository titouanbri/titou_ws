...
class admittance_control(object):
    def __init__(self):
        rospy.init_node("joystick_ur30", anonymous=True)
        ...
        rospy.Subscriber('/joysticks_publisher', WrenchStamped, self.force_callback) # sensor used to acquire forces 
    ...
    def admittance_openloop(self) :
        ...
        dt =1/frequence
        force_dead_zone_cart = 0.1  # avoid useless publishment
...
def main():
    try:
        ...
        # os.system("pkill -f joysticks_publisher.py")
        ...
        subprocess.Popen(["rosrun", "carnicero", "joysticks_publisher.py"])
        # subprocess.Popen(["rosrun", "carnicero", "joysticks_publisher.py"])
